...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(Iref_GPIO_Port, Iref_Pin);

    HAL_GPIO_DeInit(Vbus_GPIO_Port, Vbus_Pin);

    HAL_GPIO_DeInit(IbridgeA_GPIO_Port, IbridgeA_Pin);

    HAL_GPIO_DeInit(IbridgeB_GPIO_Port, IbridgeB_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP1_MspDeInit 0 */
    ...
    PB0     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(GPIOC, Vbus_Pin|GPIO_PIN_5);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PG14     ------> USART10_DE
    */
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_14);
