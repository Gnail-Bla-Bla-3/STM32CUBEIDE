...
uint32_t frequencyMotor[11] = {2050, 3900, 4390, 4820, 5170, 5800, 6467, 7422, 7886, 8700, 0};
uint8_t MHLLNotes[35] = {6, 5, 4, 5, 6, 10, 6, 10, 6, 5, 10, 5, 10, 5, 6, 8, 10, 8, 6, 5, 4, 5, 6, 10, 6, 10, 6, 10, 6, 5, 10, 5, 6, 5, 4};
uint8_t MHLLRests[35] = {30, 30, 30, 30, 29, 1, 29, 1, 60, 29, 1, 29, 1, 60, 30, 29, 1, 60, 30, 30, 30, 30, 29, 1, 29, 1, 29, 1, 30, 29, 1, 30, 30, 30, 120};

uint8_t countryRoadsNotes[37] = {1, 2, 3, 10, 3, 1, 2, 10, 3, 2, 1, 10, 1, 3, 5, 6, 10, 6, 10, 6, 5, 3, 10, 3, 2, 1, 2, 3, 10, 2, 1, 10, 1, 2, 1, 2, 1};
uint8_t countryRoadsRests[37] = {40, 20, 180, 80, 40, 20, 180, 80, 40, 20, 180, 40, 40, 40, 20, 180, 80, 39, 1, 20, 40, 120, 40, 40, 40, 20, 60, 120, 80, 40, 19, 1, 180, 80, 40, 20, 20};
...
uint32_t MarryHadALittleLambNotes() {
	if (timeTracker > MHLLRests[noteTracker]) {
		noteTracker++;
		timeTracker = 0;
	}
