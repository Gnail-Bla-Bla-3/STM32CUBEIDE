...
//sentry recieve
int16_t CAL_TargetX = -320;
int16_t CAL_TargetY = -240;
int16_t CAL_TargetWidth = 0;
int16_t CAL_TargetHeight = 0;
uint8_t CAL_TargetColour = 0;
uint8_t CAL_CVSeq = 0;

int16_t CAL_LastTargetX = -320;
int16_t CAL_LastTargetY = -240;
int16_t CAL_LastTargetWidth = 0;
int16_t CAL_LastTargetHeight = 0;
